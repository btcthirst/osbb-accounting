...
- ✅ **Управління користувачами** - повний CRUD для адміністраторів
...
**Варіант 3: Повне очищення**
```bash
# 1. Видаліть базу даних
...
1. **БД створена старою міграцією** - видаліть `~/.osbb-accounting/` і перезапустіть
2. **Неправильний хеш в БД** - запустіть `debug/test_auth.go`
3. **Помилка в логіці аутентифікації** - перевірте логи
