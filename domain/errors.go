...
// =============================================================================
// Помилки валідації для OSBB
// =============================================================================

var (

	// ErrOSBBAddressRequired повертається при порожній адресі
	ErrOSBBAddressRequired = errors.New("адреса будинку є обов'язковою")

	// ErrInvalidEDRPOU повертається при невалідному коді ЄДРПОУ
	ErrInvalidEDRPOU = errors.New("невалідний код ЄДРПОУ (має бути 8 цифр)")

	// ErrInvalidBaseRate повертається при невалідному базовому тарифі
	ErrInvalidBaseRate = errors.New("базовий тариф не може бути від'ємним")

	// ErrChairmanNameRequired повертається при порожньому ПІБ голови
	ErrChairmanNameRequired = errors.New("ПІБ голови правління є обов'язковим")

	// ErrBankAccountRequired повертається при порожньому розрахунковому рахунку
	ErrBankAccountRequired = errors.New("розрахунковий рахунок є обов'язковим")

	// ErrOSBBNotFound повертається, коли ОСББ не знайдено
	ErrOSBBNotFound = errors.New("ОСББ не знайдено")

	// ErrOSBBAlreadyExists повертається при спробі створити друге ОСББ
	ErrOSBBAlreadyExists = errors.New("ОСББ вже існує в системі")
)

// =============================================================================
// Помилки валідації для Owner
// =============================================================================

var (
	// ErrOwnerNameRequired повертається при порожньому ПІБ власника
	// (дублюється з domain/errors.go для узгодженості)
	// ErrOwnerNameRequired = errors.New("ПІБ власника є обов'язковим")

	// ErrInvalidOwnerID повертається при невалідному ID власника
	ErrInvalidOwnerID = errors.New("невалідний ID власника")
)

// =============================================================================
// Помилки валідації для PersonalAccount
// =============================================================================

var (

	// ErrAccountClosed повертається при спробі операції з закритим рахунком
	ErrAccountClosed = errors.New("особистий рахунок закрито")

	// ErrAccountAlreadyAssigned повертається при спробі призначити рахунок квартирі, яка вже має рахунок
	ErrAccountAlreadyAssigned = errors.New("квартира вже має призначений особистий рахунок")

	// ErrCannotCloseAccountWithDebt повертається при спробі закрити рахунок з боргом
	ErrCannotCloseAccountWithDebt = errors.New("не можна закрити рахунок з непогашеною заборгованістю")
)
